...
/// <summary>
/// Generated Class for Table : BLLlogisticmanager.
/// </summary>

public class BLLlogisticmanager
{
	private static BLLlogisticmanager defaultInstance = new BLLlogisticmanager();

	public static BLLlogisticmanager Default 
	{
		get { return defaultInstance; }
	}

	public BLLlogisticmanager()
	{

	}

	public List<OBJlogisticmanager> Select()
	{
		try
		{
			string query = "SELECT * FROM logisticmanager";
			DataTable dt = DAL.Default.Select(query);
			List<OBJlogisticmanager> ObjList = new List<OBJlogisticmanager>();
			foreach (DataRow dr in dt.Rows)
			{
				OBJlogisticmanager obj_OBJlogisticmanager = new OBJlogisticmanager();
				obj_OBJlogisticmanager.LMID = Convert.ToInt32(dr["LMID"]);
				obj_OBJlogisticmanager.Employee_EID = Convert.ToInt32(dr["Employee_EID"]);
				ObjList.Add(obj_OBJlogisticmanager);
			}
			return ObjList;
		}
		catch (Exception ex)
	...
	public List<OBJlogisticmanager> Select(string orderby, string orderparam)
	{
		try
		{
			string query = "SELECT * FROM logisticmanager ORDER BY " + orderby + " " + orderparam;
			DataTable dt = DAL.Default.Select(query);
			List<OBJlogisticmanager> ObjList = new List<OBJlogisticmanager>();
			foreach (DataRow dr in dt.Rows)
			{
	...
	public OBJlogisticmanager Select(int LMID)
	{
		try
		{
			string query = "SELECT * FROM logisticmanager WHERE LMID = " + LMID;
			DataTable dt = DAL.Default.Select(query);
			OBJlogisticmanager obj_OBJlogisticmanager = new OBJlogisticmanager();
			DataRow dr = dt.Rows[0];
			obj_OBJlogisticmanager.LMID = Convert.ToInt32(dr["LMID"]);
			obj_OBJlogisticmanager.Employee_EID = Convert.ToInt32(dr["Employee_EID"]);
			return obj_OBJlogisticmanager;
		}
		catch (Exception ex)
		{
			ErrorLogHelper.Default.LogException(ex);
	...
	public List<OBJlogisticmanager> Select(string nextPart)
	{
		try
		{
			string query = "SELECT * FROM logisticmanager WHERE " + nextPart;
			DataTable dt = DAL.Default.Select(query);
			List<OBJlogisticmanager> ObjList = new List<OBJlogisticmanager>();
			foreach (DataRow dr in dt.Rows)
			{
	...
	public List<OBJlogisticmanager> Select(OBJlogisticmanager obj_OBJlogisticmanager)
	{
		try
		{
			if (obj_OBJlogisticmanager.IsFiltered)
			{
				string nextPart = "";
				foreach (FilteredItems filtereditems in obj_OBJlogisticmanager.FilterList)
				{
	...
	public List<OBJlogisticmanager> Select(OBJlogisticmanager obj_OBJlogisticmanager, string orderby, string orderparam)
	{
		try
		{
			if (obj_OBJlogisticmanager.IsFiltered)
	...
	public List<OBJlogisticmanager> Select(List<OBJlogisticmanager> list_obj_OBJlogisticmanager)
	{
		try
		{
			string nextPart = "";
			foreach (OBJlogisticmanager obj_OBJlogisticmanager in list_obj_OBJlogisticmanager)
			{
				if (obj_OBJlogisticmanager.IsFiltered)
				{
	...
	public List<OBJlogisticmanager> Select(List<OBJlogisticmanager> list_obj_OBJlogisticmanager, string orderby, string orderparam)
	{
		try
		{
			string nextPart = "";
	...
	public bool Insert(OBJlogisticmanager obj_OBJlogisticmanager)
	{
		try
		{
			string query = "INSERT INTO logisticmanager (Employee_EID) VALUES ("
							+ (obj_OBJlogisticmanager.Employee_EID == 0 ? "0" : "'" + obj_OBJlogisticmanager.Employee_EID + "'") + ")";
	...
	public bool Insert(List<OBJlogisticmanager> listobj_OBJlogisticmanager)
	{
	bool ret = false;
	 foreach(OBJlogisticmanager obj_OBJlogisticmanager in listobj_OBJlogisticmanager)
	{
		try
		{
			string query = "INSERT INTO logisticmanager (Employee_EID) VALUES ("
	...
	public OBJlogisticmanager Insert_Return(OBJlogisticmanager obj_OBJlogisticmanager)
	{
		try
		{
			string query = "INSERT INTO logisticmanager (Employee_EID) VALUES ("
							...
							+ "; SELECT LMID FROM logisticmanager ORDER BY LMID DESC LIMIT 1";
			DataTable dt= DAL.Default.Select(query);
			DataRow dr = dt.Rows[0];
			obj_OBJlogisticmanager.LMID = Convert.ToInt32(dr["LMID"]);
			return obj_OBJlogisticmanager;
	...
	public bool Update(OBJlogisticmanager updateObject) 
	{
		try
		{
			if (updateObject.IsFiltered)
			{
				string query = "UPDATE logisticmanager SET ";
				string queryWhere = "";
				bool counter = false;
				foreach (FilteredItems filtereditems in updateObject.FilterList)
				{
					if (filtereditems.FilterAttribute == "LMID")
					{
			...
			else
			{
				if (updateObject.LMID != 0)
				{
					...
					sqlCount++;
					query += " WHERE LMID = " + updateObject.LMID;
					return DAL.Default.Execute(query);
				}
				else
				{
	...
	public bool UpdateWot(OBJlogisticmanager updateObject) 
	{
		try
		{
			if (updateObject.IsFiltered)
	...
	public bool Update(List<OBJlogisticmanager> listupdateObject)
	{
	bool ret = false;
	 foreach(OBJlogisticmanager updateObject in listupdateObject)
	{
		try
		{
			if (updateObject.IsFiltered)
	...
	public bool Delete(int LMID)
	{
		try
		{
			string query= "DELETE FROM logisticmanager WHERE LMID = " + LMID;
			return DAL.Default.Execute(query);
		}
		catch (Exception ex)
		{
	...
	public bool Delete(OBJlogisticmanager deleteObject)
	{
		try
		{
			List<OBJlogisticmanager> objList = this.Select(deleteObject);
			foreach (OBJlogisticmanager obj_OBJlogisticmanager in objList)
				this.Delete(obj_OBJlogisticmanager.LMID);
			return true;
		}
		catch (Exception ex)
		{
	...
	public bool Delete(List<OBJlogisticmanager> listdeleteObject)
	{
	bool ret = false;
	foreach(OBJlogisticmanager deleteObject in listdeleteObject)
		{
		try
		{
			List<OBJlogisticmanager> objList = this.Select(deleteObject);
